...
export default class GlistenClient extends Vue {
  ...
  @Prop({ required: false, default: 'Thanks for letting us know how do you like this and sending your feedback to further improve.' })
  public greetings!: string;

  // Label displayed in text field
  @Prop({ required: false, default: 'Leave us a comment' })
